...
/* Define to 1 if use sanei_debug_ndebug*/
#define NDEBUG 1
...
/* Define to 1 if you have the `jpeg_crop_scanline' function. */
#define HAVE_JPEG_CROP_SCANLINE 1

/* Define to 1 if you have the `jpeg_skip_scanlines' function. */
#define HAVE_JPEG_SKIP_SCANLINES 1
...
/* Define to 1 if libsnmp is available */
...
/* Define to 1 if libpoppler-glib is available */
//#define HAVE_POPPLER_GLIB 0
...
#define PACKAGE_BUGREPORT "sane-devel@alioth-lists.debian.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "sane-backends"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "sane-backends 1.1.1.404-596f7"
...
#define PACKAGE_VERSION "1.1.1.404-596f7"

/* Define if pthread_t is integer. */
#define PTHREAD_T_IS_INTEGER 1

/* SANE DLL revision number */
#define SANE_DLL_V_BUILD 1
...
#define VERSION "1.1.1.404-596f7"
